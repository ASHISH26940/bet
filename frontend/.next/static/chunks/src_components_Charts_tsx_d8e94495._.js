...
function CryptoGraph() {
    ...
    const [betBalance, setBetBalance] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CryptoGraph.useEffect": ()=>{
            ws.current = new WebSocket("ws://localhost:8080/ws/");
            ws.current.onmessage = ({
                "CryptoGraph.useEffect": (event)=>{
                    const msg = JSON.parse(event.data);
                    if (msg.type === "price_update" && msg.usd_value) {
                        setDataPoints({
                            "CryptoGraph.useEffect": (prev)=>[
                                    ...prev.slice(-100),
                                    {
                                        x: Date.now(),
                                        y: msg.usd_value
...
_s(CryptoGraph, "nyAZGmMvOa8HvXRhvo4r0w1NF+o=");
_c = CryptoGraph;
var _c;
__turbopack_context__.k.register(_c, "CryptoGraph");
...
//# sourceMappingURL=src_components_Charts_tsx_d8e94495._.js.map